...
<?php echo e(Form::open(array('action'=>array('App\Http\Controllers\clienteController@update', $cliente->id),'method'=>'patch'))); ?>
...
class="form-control"
value="<?php echo e($cliente->documento_identidad); ?>">
</div>
<div class="col-md-4">
...
value="<?php echo e($cliente->apellido); ?>">
</div>
<div class="col-6">
...
<?php echo $__env->make('layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appPrueba2\resources\views/cliente/edit.blade.php ENDPATH**/ ?>